public interface INuGetApiService
{
  ...
  Task<string?> DeletePackageAsync(string packageId, string? apiKey = null);
  Task<bool> DeletePackageVersionAsync(string packageId, string version, string? apiKey = null);
